                            ...
                            <ul>
                                {group.contacts.map((contact, i) => (
                                    ...
                                    >
                                        ...
                                        {contact.role && (
                                            <span className={`${contact.role === "کد پرسنلی" ? 'font-semibold' : ''} text-xs sm:text-sm text-black-600 flex-grow text-center whitespace-nowrap overflow-hidden `}> {contact.role}</span>
                                        )}
