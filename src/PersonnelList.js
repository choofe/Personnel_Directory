...
const shiftTeams = {
    A: ["مهدي محمد نژاد", "سياوش عبدي" , "احسان زماني زاده" ,  "محمد ابراهيمي",
        "حميد نوريان" , "مهدي بيات", "حامد کشوري مودب"],
    B: ["محمد پروين", "محمد اکبري", "محمد جواد بک ورديلو" , "جواد مهين زارع" , 
        "حميد رضا آسياباني", "مجيد اسماعيلي", "پدرام آذر فرين", "ميلاد خيرخواه"],
    C: [ "محمد رضا رخشان", "محمد امين کوليسه وند" , "مصطفي يار محمدي","حميد مير بزرگي" , 
            "علي خودسياني", "عليرضا رحيمي", "عباس رشيدزاده"]
};
...
const getCurrentShift = () => {
    ...
    const shiftIndex = Math.floor(elapsedMinutes / (12 * 60)) % 3; // Changed to 12-hour shift
